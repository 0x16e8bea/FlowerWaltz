...
public class FlockSimulation : MonoBehaviour {
    ...
    public Material BoidMaterial {
        get { return _boidMaterial; }
        set { _boidMaterial = value; }
    }
    ...
    private void Update() {
        ...
        _boidMaterial.SetBuffer("positionBuffer", _positionBuffer);
        _boidMaterial.SetBuffer("rotationBuffer", _rotationBuffer);

        Graphics.DrawMeshInstancedIndirect(
            _instanceMesh, 0, _boidMaterial,
